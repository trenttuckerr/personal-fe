...
!(function (t, e) {
      ...
      return (
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (n ||
                ((n = new t(this, o)), i.default(this).data(E, n)),
              'number' == typeof e)
            )
              n.to(e);
    ...
    W = (function () {
      ...
      return (
        ...
        (e._addAriaAndCollapsedClass = function (t, e) {
          ...
          e.length &&
            i.default(e).toggleClass(H, !n).attr('aria-expanded', n);
        }),
  ...
  i
    .default(document)
    .on('click.bs.collapse.data-api', q, function (t) {
  ...
  function et(t) {
    ...
    for (
      var e = tt(10) ? document.body : null,
          ...
          if (
            ...
            for (
              ...
              var a = t._getParentFromElement(n[o]),
                ...
                l = { relatedTarget: n[o] };
              if (
                (e && 'click' === e.type && (l.clickEvent = e), s)
              ) {
                var u = s._menu;
                if (
  ...
  var ue = 'bs.modal',
    ...
    Se = (function () {
      ...
      return (
        ...
        (e._getConfig = function (t) {
          return (
            (t = a({}, Te, t)), u.typeCheckConfig('modal', t, Ce), t
          );
        }),
        ...
        (t._jQueryInterface = function (e, n) {
          return this.each(function () {
            ...
            if (
              (o ||
                ((o = new t(this, r)), i.default(this).data(ue, o)),
              'string' == typeof e)
            ) {
              if ('undefined' == typeof o[e])
                throw new TypeError('No method named "' + e + '"');
            ...
            (function (t, e) {
              ...
              if (-1 !== e.indexOf(n))
                return (
                  -1 === Ne.indexOf(n) ||
                  Boolean(
                    De.test(t.nodeValue) || Ae.test(t.nodeValue)
                  )
                );
              for (
      ...
      return (
        ...
        (e._enter = function (t, e) {
          ...
          (e = e || i.default(t.currentTarget).data(n)) ||
            ...
            t &&
              (e._activeTrigger['focusin' === t.type ? qe : Me] = !0),
        ...
        (o._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (e ||
                ((e = new o(this, n)), i.default(this).data(Ye, e)),
              'string' == typeof t)
            ) {
      ...
      return (
        ...
        (e._getConfig = function (t) {
          if (
            ...
            e ||
              ((e = u.getUID(Ze)), i.default(t.target).attr('id', e)),
              (t.target = '#' + e);
          }
      ...
      return (
        (e.show = function () {
          ...
          if (
            ...
            if (o) {
              var a =
                'UL' === o.nodeName || 'OL' === o.nodeName ? mn : pn;
