...
describe('Contact Component', () => {
    ...
    it('has the correct links', () => {
        ...
        expect(emailLink).toHaveAttribute('href', 'mailto:ttucker296@gmail.com');
        expect(linkedinLink).toHaveAttribute('href', 'https://www.linkedin.com/in/-trent-tucker');
    });

    it('has the correct class names', () => {
        const { container } = render(<Contact />);
        const contactBox = container.querySelector('.contact');
        const contactButtons = container.querySelector('.contact-buttons');
